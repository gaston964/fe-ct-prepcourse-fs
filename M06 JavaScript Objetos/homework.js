...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   // Retornar el arreglo.
   // Tu código:
   // Iterar a través de cada usuario en el arreglo.
   for (let i = 0; i < objetoMuchosUsuarios.length; i++) {
      // Establecer la propiedad "esPremium" de cada usuario como true.
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Iterar a través de cada post del usuario.
   for (let post of objetoUsuario.posts) {
      if (post.likes) {
         // Sumar los likes de cada post al total.
         likes += post.likes;
      }
   }
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   // Precio final ---> 8
   // Tu código:
   // Agrega una propiedad "calcularPrecioDescuento" que es una función.
   objetoProducto.calcularPrecioDescuento = function () {
      // Multiplica el precio del producto por el porcentaje de descuento.
      ...
      // Retorna el precio final con descuento.
